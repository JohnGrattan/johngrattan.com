        ...
        <div className="timeline container mt-5">
          <div className="content-container left">
            <div className="content bg-texture-2">
              <h3>
                <i className="fas fa-handshake mr-3 text-info"></i>
                Learning Phase
              </h3>
              <hr className="secondary" />
              <p className="text-muted">
                It's my job to learn and understand every aspect of your
                business. From <strong className="text-info">your brand</strong>{' '}
                and <strong className="text-info">your personality</strong> to{' '}
                <strong className="text-info">your services</strong> and{' '}
                <strong className="text-info">your clients</strong>, I'll need a
                full evaluation. This will allow me to create an{' '}
                <strong className="text-info">
                  accurate digital representation
                </strong>{' '}
                of your company and identify important{' '}
                <strong className="text-info">customer demographics</strong>.
              </p>
            </div>
          </div>
          <div className="content-container right">
            <div className="content bg-texture-2">
              <h3>
                <i className="fas fa-stethoscope mr-3 text-info"></i>
                Diagnostic Phase
              </h3>
              ...
              <p className="text-muted">
                ...
                <strong className="text-info">your challenges</strong> to figure
                out what exactly needs to be done to{' '}
                <strong className="text-info">
          ...
          <div className="content-container left">
            <div className="content bg-texture-2">
              <h3>
                {' '}
                <i className="fas fa-pencil-ruler mr-3 text-info"></i>
                Blueprint Phase
              </h3>
              <hr className="secondary" />
              <p className="text-muted">
                ...
                <strong className="text-info">analyze your competition</strong>,
                strategically perform{' '}
                <strong className="text-info">keyword research</strong> and
                build a structured{' '}
                <strong className="text-info">site map</strong> to organize your
                content creation. From here, we can outline a development
                schedule to{' '}
                <strong className="text-info">
          ...
          <div className="content-container right">
            <div className="content bg-texture-2">
              <h3>
                <i className="fas fa-palette mr-3 text-info"></i>Design Phase
              </h3>
              <hr className="secondary" />
              <p className="text-muted">
          ...
          <div className="content-container left">
            <div className="content bg-texture-2">
              <h3>
                <i className="fab fa-react mr-3 text-info"></i>Development Phase
              </h3>
              <hr className="secondary" />
              <p className="text-muted">
                ...
                <strong className="text-info">clean, robust and secure</strong>{' '}
          ...
          <div className="content-container right">
            <div className="content bg-texture-2">
              <h3>
                <i className="fas fa-search-dollar mr-3 text-info"></i>SEO Phase
              </h3>
              <hr className="secondary" />
              <p className="text-muted">
                This is where the{' '}
                <strong className="text-info">long term SEO</strong> and{' '}
                <strong className="text-info">short term SEM</strong> tactics
                ...
                backlink generation,{' '}
                <strong className="text-info">local SEO strategy</strong>,
                pay-per-click advertising campaigns with{' '}
                <strong className="text-info">optimized landing pages</strong>{' '}
          ...
          <div className="content-container left">
            <div className="content bg-texture-2">
              <h3>
                <i className="fas fa-sync-alt mr-3 text-info"></i>
                Refinement Phase
              </h3>
              <hr className="secondary" />
              <p className="text-muted">
                Ongoing metrics analysis and data monitoring will often result
                in{' '}
                <strong className="text-info">
