...
const PrivacyPage__Header = ({ className, hOne }) => {
  const data = useStaticQuery(graphql`
    query PrivacyPage__HeaderQ {
      masthead: file(relativePath: { eq: "images/bg-img-privacy.jpg" }) {
        childImageSharp {
...
export default PrivacyPage__Header;
