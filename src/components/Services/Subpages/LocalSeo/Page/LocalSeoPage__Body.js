...
// BG Query
const LocalSeoPage__Body = ({ className }) => {
  const data = useStaticQuery(graphql`
    query LocalSeoPage__BodyQ {
      texture: file(
    ...
    >
      <div className="container">
        <div className="row justify-content-center align-items-center border bg-white shadow rounded position-sticky">
          ...
          <LocalSeoPage__Section className="container my-5 mx-3 border rounded shadow bg-img-gray-gradient" />
        </div>
      </div>
    </BackgroundImage>
  );
...
export default LocalSeoPage__Body;
